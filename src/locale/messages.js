...
const messages = defineMessages({
	...
	becomeAHoomer: {
		id: 'rentall.becomeAHoomer',
		defaultMessage: 'Become a Hoomer',
		description: 'Menu item'
	},
	help: {
		id: 'rentall.help',
	...
	howManyBedrooms: {
		...
		defaultMessage: 'How many bedrooms/beds?',
	...
	processFlowHeading: {
		...
		defaultMessage: 'Earn Extra Money and Become a Host with Hoomis',
	...
	stepOneHeading: {
		...
		defaultMessage: 'Why host with Hoomis?',
		description: 'Step 1'
	},
	stepTwoHeading: {
	...
	stepTwoFlow: {
		...
		defaultMessage:
			'Stay in control with Hoomis. You have full control of your availability, rates and rules. You can, block dates, set check-in times and manage your own communications directly with your guests through the system.',
		description: 'Step 2'
	},
	stepThreeFlow: {
	...
	topBannerTitle: {
		...
		defaultMessage: 'Its simple to become a Hoomis host',
		description: 'Report User'
	},
	footerTerms: {
		id: 'rentall.footerTerms',
		defaultMessage: 'Language, Currency & More',
